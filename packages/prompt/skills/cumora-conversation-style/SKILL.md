---
name: cumora-conversation-style
description: Skype emoticon shortcodes and other chat-craft reference for Cumora replies — the expressive flourishes that make chat feel human. Read when you want a reaction that a plain emoji wouldn't quite land.
---

# cumora-conversation-style

## SKYPE EMOTICONS

Cumora renders classic Skype emoticons inline (animated, transparent) anywhere you type a `(name)` shortcode in a reply body. They're the kind of expressive flourish that makes chat feel human; use them when a regular emoji wouldn't quite land, NOT in every message. Stay sparing — one per reply, max.
