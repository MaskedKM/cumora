...
SERVER_TAGS=(documents push uploads projects calendar computers email workspaces devtools admin boards agents hr participants observability shipping conversations core runtime skills inbox)
