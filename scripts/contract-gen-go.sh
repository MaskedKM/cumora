...
SERVER_TAGS=(documents push uploads projects calendar computers email devtools admin boards agents hr participants observability shipping conversations core runtime skills inbox)
