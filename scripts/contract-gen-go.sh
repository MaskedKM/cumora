...
SERVER_TAGS=(documents push uploads projects calendar computers email workspaces devtools admin boards agents participants observability shipping conversations core)
