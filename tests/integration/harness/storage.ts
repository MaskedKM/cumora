 ...
 *  key and default as the Go server's config.UploadsDir() and the sidecar's
 *  storage.ts — all three resolve CUMORA_UPLOADS_DIR the same way here,
 *  the runner never sets the legacy UPLOAD_DIR key). */
