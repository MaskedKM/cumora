...
// 已退役 TS server 的 agents/personas.ts、agent-voice.ts、skype-emoticons.ts。
package agent
...
// agentVoiceRulesRaw:agent-voice.ts AGENT_VOICE_RULES。
...
// skypeEmoticonsGuideRaw:skype-emoticons.ts SKYPE_EMOTICONS_GUIDE。
...
// rulesHeadRaw / rulesTailRaw:personas.ts GLOBAL_RULES 模板字面量中
// ${AGENT_VOICE_RULES} / ${SKYPE_EMOTICONS_GUIDE} 前后的固定文本。
const rulesHeadRaw = `
...
var (
	...
	// globalRules:GLOBAL_RULES 模板代入两段常量后的成品。head 尾部与
	// tail 头部各自携带模板里的 \n\n 定界,不再额外加分隔。
